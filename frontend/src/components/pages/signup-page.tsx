        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-start gap-2">
            ...
            <label htmlFor="terms" className="text-sm text-muted-foreground">
              J'accepte les{' '}
              <a href="#" className="text-[#FFC107] hover:underline">conditions d'utilisation</a>
              {' '}et la{' '}
              <a href="#" className="text-[#FFC107] hover:underline">politique de confidentialité</a>
            </label>
          </div>
          ...
          <p className="text-center text-sm text-muted-foreground">
            ...
            <Link href="/login" onClick={clearError} className="text-[#FFC107] hover:underline">
              Se connecter
            </Link>
          </p>
        </form>
